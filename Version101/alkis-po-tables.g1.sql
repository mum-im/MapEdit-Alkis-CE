...
--- neu mum
SELECT alkis_dropobject('po_labels_point');
CREATE TABLE po_labels_point(
	ogc_fid serial PRIMARY KEY,
	gml_id character(16) NOT NULL,
	gml_ids character(16)[] NOT NULL,
	thema varchar NOT NULL,
...
COMMENT ON TABLE po_labels_point IS 'BASE: Beschriftungsobjekte Punkte';
SELECT AddGeometryColumn('po_labels_point','point', :alkis_epsg, 'GEOMETRY', 2);
...
CREATE INDEX po_labels_point2_idx ON po_labels_point USING gist (point);
