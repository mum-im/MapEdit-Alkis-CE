...
-- ins PostRun verschoben
--\set alkis_rebuildmap 1
--\if :alkis_rebuildmap
...
DELETE FROM po_pto;
DELETE FROM po_lto;
UPDATE po_lastrun SET lastrun=null, npoints=0, nlines=0, npolygons=0, nlabels=0;
--\endif
...
UPDATE po_lastrun SET lastrun='1001-01-01T01:00:00Z' WHERE lastrun IS NULL;
